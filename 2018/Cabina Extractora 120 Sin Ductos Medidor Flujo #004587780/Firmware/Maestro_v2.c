...
char  Baje_Vidrio[] = "!!Ubique Vidrio!!",Inflowt[] = "JPCEGH-F-A",Downflowt[] = "Inflow(m/s):", ZF[] = "Fabrica:208.0", ZA[] = "Actual:",AJ[]="Ajuste:";
...
float Leer_Sensor_Presion(int media){
   ...
   Filtro_Downflow_adc=sensores(3);
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      { 
         ...
         if(VIDRIOUP)
         {
            Motor_on;tiempo_purga=0;glcd_text57(10,55, Baje_Vidrio, 1, ON);
         }
