...
int16 t_latencia=0,minutos_uv=0,minutos_trabajo=0,G16=0,tup=0,tdown=0,tright=0,tleft=0,tvidrio=0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      if(Menu==2){ //Menu General.
         ...
         if(imprimir==1){
            ...
            strcpy(Menus.Letra,"JPCEGH110-AC");
      ...
      if(tright>=30){//Si oprime boton de Blower.
         if(Flanco3 == 0){
