...
#define   O2_on             output_bit(PIN_C0,1)
#define   O2_off            output_bit(PIN_C0,0)
...
short imprimio=0,Ruido=0,flagup=0,flagdn=0;
signed int8   paso=0;
char t[3]={'>',' ','^'}; 
...
//------------Menu0------------------------------------------------------------------   
   ...
   /*if(Menu==9){ //Menu Movimiento de Vidrio
      MenuVidrio();
   }*/
...
//-------------------Menu20----------------------------------------------------------------  
   if(Menu==20){
      ...
      if(UP){// Si oprime Arriba
         ...
         if(!flagup){
            ...
            if(UP){
               ...
               Flanco1 = 1;printf(lcd_putc,"\f");Menu=1;paso=0;Flecha=2;Flecha2=2;unidad=11;
               lcd_gotoxy(1,1);
      ...
      if(RIGHT){// Si oprime Derecha
         delay_ms(20);
         if(RIGHT && Flanco3 == 0){
            delay_ms(500);printf(lcd_putc,"\f");Menu=40;Flanco3=1;
         }
      }else{
         Flanco3 = 0;
      }
