...
#define   LuzBlanca_on        output_bit(PIN_C1,0)
#define   LuzBlanca_off       output_bit(PIN_C1,1)
#define   Aux_on              output_bit(PIN_C0,0)
#define   Aux_off             output_bit(PIN_C0,1)
...
#define   O2_on               output_bit(PIN_C5,1)
#define   O2_off              output_bit(PIN_C5,0)
#define   O1_on               output_bit(PIN_C4,1)
#define   O1_off              output_bit(PIN_C4,0)
...
short tiempo_purga=0,tiempo_trabajo=0,flag_latencia=0,tiempo_postpurga=0,pulsoSubir=OFF,pulsoBajar=OFF,flag_arriba=OFF,flagdn=OFF,flagup=OFF;
...
//-------Inicio de Cabina-------------------------------------------------------------------------//
   ...
   //glcd_filScreen(OFF);      //Limpia la pantalla
   glcd_init(ON);
   Menu=200;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      while(Menu==2){ //Menu General.
         ...
         if(imprimir==1){
            ...
            strcpy(Menus.Letra,"JPCEGH180-BB");
