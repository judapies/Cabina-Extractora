...
char  JP[] = "JP Inglobal", Cabina[] = "      Cabina",Dos_puntos[]=":",UV[]="UV";
char  Clase[] = "Extractora", Tiempo[] = "Tiempo de Purga";
...
short Cruce=OFF,Purga=OFF,alarmaFiltro=OFF;
int16 tiempocruce=0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      if(Menu==2){ //Menu General.
         ...
         if(imprimir==1){
            ...
            if(Ttrabajo[3]>=2){
               strcpy(Menus.Letra,"!Cambie Filtros!");
            }else{
               strcpy(Menus.Letra,"JPCEGH120DL-ORG");
            }
