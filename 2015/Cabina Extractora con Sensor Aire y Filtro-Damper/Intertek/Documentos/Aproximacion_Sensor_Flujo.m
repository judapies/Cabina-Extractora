...
p1=polyfit(x,yy,1);    %aproximaciòn por polinomio de segundo orden
p2=polyfit(x,yy,2);    %aproximaciòn por polinomio de tercer orden
p3=polyfit(x,yy,3);    %aproximaciòn por polinomio de tercer orden
