...
float setpoint=0.0,zero=0, zero_fabrica=501.0;//zero_fabrica=203.0;
...
float a=0.00009184184, b= -0.14341591588, c=74.67015739106 , d=-12961.46001369690; // Prueba Faiver 19 Jun 2015
